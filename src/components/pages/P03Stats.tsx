...
function Counter({
      ...
      ([e]) => {
        if (e.isIntersecting) {
          ...
          const timer = setInterval(() => {
            start += step;
            const pct = Math.min(start / dur, 1);
  ...
  return (
    <div ref={ref} className="stat-card" style={{ minWidth: 150 }}>
      ...
      <p className="tl" style={{ color: C.r4 }}>
        {label}
      </p>
    </div>
  );
...
export default function P03Stats({ onNext }: Props) {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(165deg,${C.cr} 0%,${C.r1} 100%)`,
      }}
    >
      <div
        ...
        style={{
          ...
          height: 500,
          borderRadius: "50%",
          border: "1px solid rgba(240,128,152,.15)",
          top: "50%",
          left: "50%",
          marginTop: -250,
          marginLeft: -250,
      ...
      <div
        ...
        style={{
          ...
          height: 350,
          borderRadius: "50%",
          border: "1px solid rgba(184,74,98,.1)",
          top: "50%",
          left: "50%",
          marginTop: -175,
          marginLeft: -175,
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full gap-12 px-8">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          ...
          <div className="s3-card opacity-0">
            <Counter target={612} label="Days" icon="🤍" />
          </div>
        ...
        <p
          className="s3-sub td italic opacity-0"
          style={{
